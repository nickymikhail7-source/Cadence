        ...
        <div className="min-h-screen flex items-center justify-center bg-bg-secondary">
            <div className="w-full max-w-sm">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-semibold text-text-primary mb-1">Cadence</h1>
                    <p className="text-text-tertiary text-sm">Never miss a beat</p>
                </div>
                ...
                <div className="bg-bg-primary border border-border-subtle rounded-xl p-6 shadow-sm">
                    ...
                    <p className="text-xs text-text-quaternary text-center mt-4">
                        We&apos;ll sync your Gmail and create your scheduling links
                    </p>
                </div>
                ...
                <div className="mt-6 space-y-3">
                    <div className="flex items-center gap-3 text-sm text-text-tertiary">
                        ...
                        <span>AI-powered email prioritization</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm text-text-tertiary">
                        <svg className="w-4 h-4 text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    ...
                    <div className="flex items-center gap-3 text-sm text-text-tertiary">
                        ...
                        <span>Built-in scheduling links</span>
                    </div>
                </div>
            </div>
        </div>
